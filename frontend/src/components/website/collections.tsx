...
const INDUSTRIES = ["EdTech", "Mobile", "Live streaming", "Developer tools", "Internal tools", "Media", "AI", "Fintech", "Healthtech", "Supply chain", "Energy", "Retail", "Open source"] as const;
